...
const CellWrapper = ({ img, product }) => (
  <div className="flex items-center">
    <img src={img} alt="" className="w-8 h-8 rounded-full mr-2 object-cover" />
    {product}
  </div>
);
    ...
    <Table aria-label="simple table">
      <TableHead>
        <TableRow>
          ...
          <CustomTableCell>Payment Method</CustomTableCell>
      ...
      <TableBody>
        {rows.map((row) => (
          <TableRow key={row.id}>
            ...
            <CustomTableCell>
              <CellWrapper img={row.img} product={row.product} />
            </CustomTableCell>
            ...
            <CustomTableCell>{row.method}</CustomTableCell>
            <CustomTableCell>

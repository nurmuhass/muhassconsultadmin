// pages/Employees/[id]/edit.js
import { useRouter } from 'next/router';
import { useState, useEffect } from 'react';
import { fetchEmployeeById, updateEmployeeData,uploadEmployeeImage } from '../../../lib/fetchData';
...
const EditEmployee = () => {
  ...
  const handleUpdate = async () => {
    try {
      ...
      // Update the Employee data with the new image URL
      ...
      await updateEmployeeData(id, updatedEmployeeData);
          ...
          <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
              <ol class="flex items-center gap-2">
                ...
                <li class="font-medium text-primary">Edit Employee</li>
              </ol>
            </nav>
          </div>
  ...
  <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
    ...
    <div class="p-7">
      <div class="grid grid-cols-2 gap-8">
        ...
        <div class="w-full">
          <label class="mb-3 block text-sm font-medium text-black dark:text-black" for="Role">Role</label>
          <div class="relative">
            <input
              class="w-full rounded border border-stroke pl-3 bg-gray py-3  pr-4.5 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
              placeholder="Role"
              ...
              <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="p-7">
                  ...
                  <div class="mb-4 flex items-center gap-3">
                    ...
                    <img src={imageFile ? URL.createObjectURL(imageFile) : EmployeeData.image} alt="Employee" />
                    </div>
                    <div>
